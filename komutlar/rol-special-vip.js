...
exports.run = function(client, message, args) {
  ...
  const log = new Discord.MessageEmbed()
    .setColor(`#30d5c8`)
    .setTimestamp()
    .setDescription(`<@${kişi.id}> adlı kullanıcıya **${message.author}** tarafından  <@&730128972867960893> rolü verildi.`) 
  ...
  banlog.send(log)
    ...
    .setDescription(`<@${kişi.id}> adlı kullanıcıya **${message.author}** tarafından <@&730128972867960893> rolü verildi.`) 
    .setFooter(`Yetkili : ${message.author.tag}`, message.author.avatarURL)
    kişi.roles.add('730128972867960893')
    kişi.roles.remove('729813765092278383')
